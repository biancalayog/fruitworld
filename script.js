(function () {
  ...
  // Formspree is a service that receives form submissions and emails them to you. No backend needed.
  // 1. Go to https://formspree.io and sign up (free).
  // 2. Click "New form", name it (e.g. "FruitWorld Contact").
  // 3. In the form settings, set "Email to receive submissions" to fruitworldcebu@outlook.com.
  // 4. Copy the form's endpoint URL (looks like https://formspree.io/f/abcdefgh) — that is your "Formspree URL".
  // 5. Paste it below, replacing YOUR_FORM_ID with the ID part only, e.g. https://formspree.io/f/xyzabc123
  ...
  // ——— Contact form submit: sends email via Formspree to fruitworldcebu@outlook.com ———
  // Set CONTACT_FORM_ENDPOINT at the top of this file to your Formspree form URL.
  if (contactForm) {
